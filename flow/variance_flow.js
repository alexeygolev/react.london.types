...
function showUserDashboard(user: User): Admin {
...
function renderPage(dashboard: (user: Admin) => Admin): string {
    return 'h'
}

renderPage(showUserDashboard)
...
showDashboard(currentUser) // Admin <: User
showDashboard(currentAdmin)
showDashboard(currentSuperAdmin) // SuperAdmin <: Admin
...
const v = showSuperDashboard(currentAdmin)
